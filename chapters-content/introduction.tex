...
Comprehensively covers the steps followed when implementing the deep learning pipeline, explaining the practical solutions when implementing the code.\\ %Additionally, covers any testing done to validate that the system works as expected.
