...
\caption{Results achieved on the test set when using different class weights (none, balanced and +50\% minority class) on the imbalanced CBIS-DDSM dataset with VGG19 and MobileNet architectures as base model.}
