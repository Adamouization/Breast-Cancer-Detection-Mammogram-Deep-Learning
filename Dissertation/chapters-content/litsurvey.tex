...
different cross validation folds and training/testing splits yield different accuracies.
...
Convolutional Neural Networks correspond a stack of convolutional layers seperated by pooling layers that are followed by a fully connected network for classification.
