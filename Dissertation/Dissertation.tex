...
\input{Dissertation/chapters-content/appendix/programming_languages_comparison}

\chapter{Usage Instructions}
\label{ch:appendix-usage-instructions}
\input{Dissertation/chapters-content/appendix/instructions.tex}

\chapter{Remote Work}
\label{ch:appendix-remote-work-environment}
\input{Dissertation/chapters-content/appendix/remote-work-setup.tex}

\chapter{Team Meeting Summaries}
\label{ch:appendix-team-meeting-summaries}
\input{Dissertation/chapters-content/appendix/team_meetings.tex}

\chapter{Coding Project Structure}
\label{ch:appendix-coding-project-structure}
\input{Dissertation/chapters-content/appendix/project_structure.tex}
